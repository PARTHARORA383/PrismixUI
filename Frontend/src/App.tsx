...
import NeutralBarChartPage from "./pages/Charts/BarChart/NeutralBarChartPage"
  ...
  return (
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/components/charts/NeutralBarChart/:chartId?" element = {<LayoutSidebar>
          <NeutralBarChartPage/></LayoutSidebar>}/>
